...
const PersonalDetails: React.FC<PersonalDetailsProps> = ({ nextStep }) => {
  ...
  const isFormValid = mobileNumber && idNumber && gender;

  return (
    <div className="flex flex-col min-h-screen font-fira box-border p-6">
      <div className="flex-grow flex flex-col space-y-6">
        <div className="text-xl font-bold text-left">Personal Details</div>
      ...
      <div className="mt-4 flex justify-start">
        <button
          onClick={nextStep}
          className="flex items-center justify-center px-4 py-2 border border-[#b61f2d] text-[#b61f2d] rounded disabled:opacity-50"
