...
import { Home, Personalcard, LogoutCurve, Icon } from "iconsax-react";
...
const MenuItem = ({
  ...
  <NavLink to={href} className="hover:cursor-pointer hover:drop-shadow-xl">
    {({ isActive }) => (
      <div
        className={`font-poppins flex items-center gap-4 whitespace-nowrap ${isActive ? "text-primary" : "text-gray-600"
          }`}
      >
        <Logo
          size="26"
