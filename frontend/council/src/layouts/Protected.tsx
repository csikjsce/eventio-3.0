...
const MOCK_EVENTS: Events = {
  DRAFT: [
    makeEvent({
      ...
      event_type: 'Workshop',
      state: 'DRAFT',
      dates: [new Date('2026-07-20T10:00:00').toISOString()],
  ...
  UPCOMING: [
    makeEvent({
      ...
      event_type: 'Seminar',
      state: 'UPCOMING',
      dates: [new Date('2026-06-28T09:00:00').toISOString()],
    ...
    makeEvent({
      ...
      event_type: 'Competition',
      state: 'UPCOMING',
      dates: [new Date('2026-07-10T11:00:00').toISOString()],
  ...
  REGISTRATION_OPEN: [
    ...
    makeEvent({
      ...
      state: 'REGISTRATION_OPEN',
      dates: [new Date('2026-07-05T08:00:00').toISOString()],
  ...
  ONGOING: [
    makeEvent({
      ...
      dates: [
        ...
        new Date('2026-05-02T09:00:00').toISOString(),
        new Date('2026-05-03T09:00:00').toISOString(),
      ],
  ...
  COMPLETED: [
    makeEvent({
      ...
      event_type: 'Talk',
      state: 'COMPLETED',
      dates: [new Date('2026-03-10T14:00:00').toISOString()],
