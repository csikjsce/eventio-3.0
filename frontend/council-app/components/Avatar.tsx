 ...
 * so typing a name never fires network traffic.
 */
...
export default function Avatar({
  ...
  if (!src?.trim() || failedSrc === src) {
    return (
      <div
        className={`bg-[#b61f2d] text-white flex items-center justify-center font-fira font-semibold select-none ${className}`}
